...
examples = @ExampleObject(
    ...
    @GetMapping("/search")
    public ResponseEntity<?> groupSearch(
    ...
    @PostMapping("/code")
    public ResponseEntity<?> groupCodeGeneration(
    ...
    public ResponseEntity<?> groupCodeSearch(
            @Parameter(description = "그룹 id")
            @RequestParam Integer groupid);
    ...
    public ResponseEntity<?> groupSerachwithCode(
            @Parameter(description = "그룹 id")
    ...
    @PostMapping("/access")
    public ResponseEntity<?> groupAccess(
    ...
    @DeleteMapping("/quit")
    public ResponseEntity<?> groupQuit(
            @Parameter(description = "그룹 id")
    ...
    public ResponseEntity<?> groupUserDelete(
            @Parameter(description = "그룹 id")
            @RequestParam Integer groupId,
    ...
    public ResponseEntity<?> serveySave(
            @Parameter(description = "그룹 id")
            @RequestParam Integer groupId,
    ...
    public ResponseEntity<?> serveySearch(
            @Parameter(description = "그룹 id")
            @RequestParam Integer groupId,HttpServletRequest request);
}
